...
% TODO correct according to feedback (make clear what is relevant for our topic and what is not, put some more technical details to parts which are relevant for our project)
...
% Light bulbs
% TODO: need to make clear in which way ZLL is relevant for us - wasnt really for project itself but due to limitations caused by bridge communication we seize ZLL as alternative solution for researches who want to send more commands at higher rate - further those researches are part of emphasizing that iot has poor security in general
...
% TODO here we need to make our relevance clear - looked at it for taxonomy part but didnt really need it for our project - ev shorten, just mention that there are two types of iot attacks according to former researches and rest is mentioned in ignoring attacks part
