...
\subsection{Extending Functionality}
	% The interesting things. I like the examples from the paper:
...
\begin{frame}{How (smart) LEDs Work}
    ...
    \only<4> {
         % add illustration brightness control (PWM duty cycle method and according brightness change)
...
% -> graphical illustration on slides, according description done verbally
