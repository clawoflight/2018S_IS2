...
\begin{frame}{Ignoring Functionality~\cite{Angrishi:2017:TitiiiviIb, Antonakakis:2017:UMB, Donno:2017:ADIM}}
	\note{m \\
	systematic insecurity, highly used for DDoS and spamming.
	TODO: read the chapter from the paper before practicing
  }
...
\begin{frame}{Reducing Functionality~\cite{Dhanjani:2013:HLSEPHPWLS, Ronen:2018:IGNCZCR, Bhartiya::YSFMK}}
	\note{m \\
		...
		Also mention the fridge murder story.

		TODO: re-read what caused the blackout - lightning?
	}
...
\begin{frame}{Extending Functionality~\cite{Ronen:2016:EFAIDCSL}}
    \only<1>{
