...
% FRAME controlling the light
% - hue API using hueadm
% - limitations: latency between commands, automatic fading

% FRAME experimental setup
% - arduino to configure the sensor
% - picoscope
% - python scripts

% FRAME results
% Some frames with plots from our results
